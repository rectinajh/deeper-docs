;(function () {
  ...
  window.addEventListener('load', () => {
    setTimeout(() => {
      ...
      banner.innerHTML = `
        <div class="popup-banner-text popup-banner-new">Automate your Deepchain operations with DeeperChain Defender — <a href="https://hubs.li/H0F1_Pt0">Learn More</a></div>
